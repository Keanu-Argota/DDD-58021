...
CREATE TABLE Customer (CustomerID BIGINT NOT NULL, CustomerName VARCHAR(24) NOT NULL, Municipality VARCHAR(24) NOT NULL, City VARCHAR(24) NOT NULL, PRIMARY KEY(CustomerID));
